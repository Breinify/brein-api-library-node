    ...
    recommendation: function () {
        overload.overload({
            'Object,Function': function (user, callback) {
                this._recommendation(user, 3, null, null, callback);
            },
            'Object,Number,Function': function (user, nrOfRecommendations, callback) {
                this._recommendation(user, nrOfRecommendations, null, null, callback);
            },
            'Object,Number,String,Function': function (user, nrOfRecommendations, category, callback) {
                this._recommendation(user, nrOfRecommendations, category, null, callback);
            },
            'Object,Number,Boolean,Function': function (user, nrOfRecommendations, sign, callback) {
                this._recommendation(user, nrOfRecommendations, null, sign, callback);
            },
            'Object,Number,String,Boolean,Function': function (user, nrOfRecommendations, category, sign, callback) {
                this._recommendation(user, nrOfRecommendations, category, sign, callback);
            }
        }, arguments, this);
    },

    _recommendation: function (user, nrOfRecommendations, category, sign, callback) {
        ...
        nrOfRecommendations = typeof nrOfRecommendations === 'undefined' || nrOfRecommendations === null ? 3 : nrOfRecommendations;
