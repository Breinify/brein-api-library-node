    ...
    recommendation: function () {
        overload.overload({
            'Object,Function': function (user, callback) {
                this._recommendation(user, 3, null, callback);
            },
            'Object,Number,Function': function (user, nrOfRecommendations, callback) {
                this._recommendation(user, nrOfRecommendations, null, callback);
            },
            'Object,Number,Boolean,Function': function (user, nrOfRecommendations, sign, callback) {
                this._recommendation(user, nrOfRecommendations, sign, callback);
            }
        }, arguments, this);
    },

    _recommendation: function (user, nrOfRecommendations, sign, callback) {
        ...
        if (sign) {
            var message = '' + payload.unixTimestamp + nrOfRecommendations;
